/datum/action/cooldown/spell/conjure/phantom_ear
	...
	summon_type = list(/obj/structure/fake_machine/phantom_ear)
	summon_radius = 0
	summon_lifespan = 0

/datum/action/cooldown/spell/conjure/phantom_ear/post_summon(atom/summoned_object)
	var first = TRUE
	for(var/obj/structure/fake_machine/phantom_ear/E in world)
	...
	if(istype(summoned_object, /obj/structure/fake_machine/phantom_ear))
		var/obj/structure/fake_machine/phantom_ear/ear = summoned_object
		ear.setup(owner)
	return
